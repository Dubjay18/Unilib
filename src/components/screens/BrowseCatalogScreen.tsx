                  ...
                  <div className="flex flex-wrap gap-3 pt-4 border-t border-border-parchment/60 dark:border-zinc-800 mt-auto">
                    {selectedBook.status === 'available' ? (
                      <button
                        ...
                        className="bg-primary hover:bg-primary-container text-on-primary font-bold text-xs py-3 px-6 rounded-lg shadow-md transition-all hover:scale-[0.99] active:scale-[0.97] flex items-center gap-1.5"
                      >
                    ...
                    <button
                      ...
                      className="bg-surface-container dark:bg-zinc-800 hover:bg-surface-container-high dark:hover:bg-zinc-700 text-on-surface font-bold text-xs py-3 px-6 rounded-lg border border-border-parchment dark:border-zinc-700 transition-all flex items-center gap-1.5"
                    >
